...
class Taxpayer extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'taxpayer_emergency_contact_fname' => 'Emergency Contact(First Name)',
            'taxpayer_emergency_contact_mname' => 'Emergency Contact(Middle Name)',
            'taxpayer_emergency_contact_lname' => 'Emergency Contact(Last Name)',
            'taxpayer_emergency_contact_suffix_name' => 'Emergency Contact (Suffix Name)',
            'taxpayer_emergency_contact_relationship' => 'Emergency Contact Relationship',
            'taxpayer_emergency_contact_number' => 'Emergency Contact Number',
            'taxpayer_emergency_contact_email_address' => 'Emergency Contact Email Address',
