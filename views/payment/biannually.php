...
<div class="payment-biannually-form">
...
<div>
    ...
    <p style="float: right;">
        <?= Html::a('Pay Other Half', ['payoptionbi', 'id' => $modelPayment->payment_id], ['class' => 'btn btn-primary']) ?>   
    </p>
</div>
...
<?php
        ...
        for($counter = 0; $counter < sizeof($arrayHalf); $counter++){
            echo "<tr>";            
            echo "<td>" . $modelPayment->payment_kind . "</td>";
            echo "<td>" . $arrayHalf[$counter]["payment_bi_annually"] . "</td>";           
            echo "<td>" . $arrayHalf[$counter]["biannually_assessment"] . "</td>";            
            echo "<td>" . $arrayHalf[$counter]["payment_status"] . "</td>";
            echo "</tr>";
        }
